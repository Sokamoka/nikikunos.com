<template>
  <section class="bg-[url('../img/niki-waves.svg')] bg-no-repeat bg-cover bg-bottom" data-st-container="hero">
    <div class="max-w-7xl mx-auto py-32 px-10 flex flex-col items-center">
      ...
      >
        Can you imagine any celebration without a cake?<br />If not, you're in the right place.
      </div>
      <div
      ...
      >
        Our community is built by cake lovers from all over the world, people that rejoice in the joy that comes with
        sharing delicious cakes with their family and friends. Cakes and sprinkles make the world a colorful and sweeter
        place.
      </div>

      <div
        class="mt-8 opacity-0 flex space-x-3"

      ...
      <div class="flex flex-col md:flex-row-reverse max-w-7xl mx-auto">
        ...
        <div class="w-full md:w-1/2">
          <div class="grid grid-cols-3 grid-rows-2">
            <div>
              <img
                src="https://pbs.twimg.com/media/FP0CbsMWUAw4wQm?format=jpg&name=large"
              />
            </div>
            <div>
              <img
      ...
      <div class="flex flex-col md:flex-row max-w-7xl mx-auto">
        <div class="w-full md:w-1/2 mb-5">
          ...
          <p class="px-10 mt-5 text-base text-gray-500 sm:text-lg md:text-lg">
            ...
            found a totally different world. First steps into WEB3 is not easy,
            but if you are curious enough you will find a genuine and supportive
            community. Carrying the cake is like opening the door to Narnia into
            a secret world full of colorful and endless possibilities.
          </p>
          <p class="px-10 mt-5 text-base text-gray-500 sm:text-lg md:text-lg">
            Together with our community members, we would like to support
            women-led project. We will decide together what new upcoming project
            to support <b>each quarter with 10%</b> of the collection’s revenue.
            We will purchase from the voted collections, which we giveaway among
            our members. We are here to lift each other up. WAGMI
          </p>
        </div>
        <div class="w-full md:w-1/2">
          <div class="grid grid-cols-3 grid-rows-2">
      ...
      <div class="flex flex-col md:flex-row-reverse max-w-7xl mx-auto">
        <div class="w-full md:w-1/2 mb-5">
          ...
          <p class="px-10 mt-5 text-base text-gray-500 sm:text-lg md:text-lg">
            ...
            special moment when all the candles are blown out and the celebrated
            one makes a wish. If you have a “ Say with cakes” piece here you can
            blow the candles on the fitting cake.
          </p>
          <p class="px-10 mt-5 text-base text-gray-500 sm:text-lg md:text-lg">
            The 10 % profit of this collection supporting special movement like
            “Grandpa Kitchen” who feed with giant cakes hundreds children. We
            need your help here, to find additional special human or community
            all over the world.
          </p>
        </div>
        <div class="w-full md:w-1/2">

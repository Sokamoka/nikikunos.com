...
import { GalleryContext, appendTo } from './internal'
...
watch(isOpen, (value) => {
  if (value) {
    ...
    appendTo(galleryRef.value, 'body')
    // nextTick(() => appendTo(galleryRef.value, 'body'))
  } else {
...
<template>
  <component :is="props.tag">
    <slot :items="items" />
    <div ref="galleryRef" role="dialog">
